...
// Add a new design gallery image
...
// Update design gallery image
export const update = mutation({
  args: {
    id: v.id("designGallery"),
...
// Reorder design gallery images
export const reorder = mutation({
  args: {
    ids: v.array(v.id("designGallery")),
    email: v.optional(v.string()), // Dev mode: email for admin check
  },
  handler: async (ctx, args) => {
