...
// Add a new portraits hero carousel image
...
// Update portraits hero carousel image
export const update = mutation({
  args: {
    id: v.id("portraitsHeroCarousel"),
...
// Delete portraits hero carousel image
...
// Reorder portraits hero carousel images
export const reorder = mutation({
  args: {
    ids: v.array(v.id("portraitsHeroCarousel")),
    email: v.optional(v.string()), // Dev mode: email for admin check
  },
  handler: async (ctx, args) => {
