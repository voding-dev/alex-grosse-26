...
// Create initial portfolio and projects with stock photos
// DEV ONLY: This function should be disabled in production
// Note: This function is similar to resetProjects - consider consolidating
export const createInitialProjects = mutation({
  args: {},
