                    ...
                    <div className="p-3 rounded-md border border-foreground/20 bg-foreground/5">
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={async () => {
                            setPortraitsFormData({ ...portraitsFormData, bookingToken: "" });
                            try {
                              await updatePortraits({
                                heroText: portraitsFormData.heroText,
                                bookingToken: "",
                                stripeUrl: portraitsFormData.stripeUrl,
                                howItWorksTitle: portraitsFormData.howItWorksTitle,
                                howItWorksSteps: portraitsFormData.howItWorksSteps.length > 0 ? portraitsFormData.howItWorksSteps : undefined,
                                services: portraitsFormData.services.length > 0 ? portraitsFormData.services : undefined,
                                email: adminEmail || undefined,
                              });
                              toast({
                                title: "Token removed",
                                description: "Booking token has been removed from the portraits page.",
                              });
                            } catch (error: any) {
                              toast({
                                title: "Error",
