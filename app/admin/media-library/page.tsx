    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 py-8 sm:py-12">
      <div className="space-y-6">
          ...
          <div className="flex gap-2">
            {selectedMedia.size > 0 && (
              <Button 
                ...
                className="font-black uppercase tracking-wider border-2 shadow-lg transition-all hover:scale-105"
                style={{ fontWeight: '900', backgroundColor: '#fff', color: '#1a1a1a', borderColor: 'rgba(0,0,0,0.2)' }}
              >
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          }`} style={{ backgroundColor: isAllSelected ? 'rgba(88, 96, 52, 0.1)' : '#fff', borderColor: isAllSelected ? '#586034' : 'rgba(0,0,0,0.15)' }}>
            <Checkbox
              checked={isAllSelected}
              onCheckedChange={handleSelectAll}
              className="h-5 w-5 border-2 data-[state=checked]:bg-accent data-[state=checked]:border-accent shadow-lg"
              style={{ borderColor: 'rgba(0,0,0,0.3)' }}
            />
            <div className="flex items-center gap-2">
              <CheckCircle className="h-4 w-4" style={{ color: isAllSelected ? '#586034' : '#999' }} />
              <span className="text-sm font-black uppercase tracking-wider" style={{ fontWeight: '900', color: '#1a1a1a' }}>
                Select All Files
              </span>
            </div>
            {selectedMedia.size > 0 && (
            ...
            <>
              <Popover open={bulkFolderDialogOpen} onOpenChange={setBulkFolderDialogOpen}>
                <PopoverTrigger asChild>
                  <Button 
                    className="font-black uppercase tracking-wider border-2 shadow-lg transition-all hover:scale-105"
                    style={{ fontWeight: '900', backgroundColor: '#fff', color: '#1a1a1a', borderColor: 'rgba(0,0,0,0.15)' }}
                  >
                    <Folder className="mr-2 h-4 w-4" />
                    Move to Folder ({selectedMedia.size})
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-80" align="start" style={{ backgroundColor: '#fff', borderColor: 'rgba(0,0,0,0.15)' }}>
                  <div className="space-y-4">
                    <div>
                      <Label className="text-sm font-semibold" style={{ color: '#1a1a1a' }}>Move to Folder</Label>
                      <p className="text-xs mt-1 mb-3" style={{ color: '#666' }}>
                      ...
                      <div className="mt-2 space-y-2">
                        ...
                        <div className="relative">
                          ...
                          {bulkFolderSuggestionsOpen && folders && folders.length > 0 && (
                            <div className="absolute z-50 w-full mt-1 rounded-md shadow-lg max-h-60 overflow-auto" style={{ backgroundColor: '#fff', borderColor: 'rgba(0,0,0,0.1)', border: '1px solid rgba(0,0,0,0.1)' }}>
                              {(() => {
                                ...
                                if (filteredFolders.length === 0 && bulkFolderValue.length === 0) {
                                  return (
                                    <div className="px-3 py-2 text-sm" style={{ color: '#666' }}>
                                ...
                                return (
                                  <>
                                    {filteredFolders.map((folder) => (
                                      <div
                                        key={folder}
                                        className="px-3 py-2 cursor-pointer hover:bg-gray-100 text-sm" style={{ color: '#1a1a1a' }}
                                        onMouseDown={(e) => {
                                          e.preventDefault();
                                    ...
                                    {bulkFolderValue.length > 0 && 
                                     !folders.some(f => f.toLowerCase() === bulkFolderValue.toLowerCase()) && (
                                      <div
                                        className="px-3 py-2 cursor-pointer hover:bg-gray-100 text-sm" style={{ color: '#1a1a1a', borderTop: '1px solid rgba(0,0,0,0.1)' }}
                                        onMouseDown={(e) => {
                                          e.preventDefault();
              ...
              <Popover open={bulkTagDialogOpen} onOpenChange={setBulkTagDialogOpen}>
                ...
                <PopoverContent className="w-80" align="start" style={{ backgroundColor: '#fff', borderColor: 'rgba(0,0,0,0.15)' }}>
                  <div className="space-y-4">
                    <div>
                      <Label className="text-sm font-semibold" style={{ color: '#1a1a1a' }}>Tag Mode</Label>
                      <Select value={bulkTagMode} onValueChange={(v) => setBulkTagMode(v as "add" | "remove" | "replace")}>
                        <SelectTrigger className="w-full mt-2 border" style={{ backgroundColor: '#fff', borderColor: 'rgba(0,0,0,0.15)', color: '#1a1a1a' }}>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    <div>
                      <Label className="text-sm font-semibold" style={{ color: '#1a1a1a' }}>Tags</Label>
                      <div className="mt-2 space-y-2">
                        ...
                        <div className="relative">
                          ...
                          {bulkTagSuggestionsOpen && tags && tags.length > 0 && (
                            <div className="absolute z-50 w-full mt-1 rounded-md shadow-lg max-h-60 overflow-auto" style={{ backgroundColor: '#fff', border: '1px solid rgba(0,0,0,0.1)' }}>
                              {(() => {
                                const currentTagsLower = new Set(bulkTagsArray.map(normalizeTag));
                                  ...
                                  <>
                                    ...
                                    {bulkTagInput.trim().length > 0 && 
                                     !tags.some(t => normalizeTag(t) === normalizeTag(bulkTagInput)) && (
                                      <div
                                        className="px-3 py-2 cursor-pointer hover:bg-gray-100 text-sm"
                                        style={{ color: '#1a1a1a', borderTop: '1px solid rgba(0,0,0,0.1)' }}
                                        onMouseDown={(e) => {
                                          e.preventDefault();
                                          const trimmedInput = bulkTagInput.trim();
                                          if (trimmedInput.length > 0 && isValidTag(trimmedInput)) {
        ...
        {/* Filters */}
        <Card style={{ backgroundColor: '#fff', borderColor: 'rgba(0,0,0,0.1)' }}>
          <CardContent className="p-4">
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <div className="flex-1 min-w-[200px]">
                <div className="relative">
                  ...
                  <Input
                    ...
                    style={{ backgroundColor: '#FAFAF9', borderColor: 'rgba(0,0,0,0.15)', color: '#1a1a1a' }}
                  />
                </div>
              </div>
              ...
              <Select value={typeFilter} onValueChange={(v) => setTypeFilter(v as any)}>
                <SelectTrigger className="w-[140px] border" style={{ backgroundColor: '#fff', borderColor: 'rgba(0,0,0,0.15)', color: '#1a1a1a' }}>
                  <SelectValue />
                </SelectTrigger>
              ...
              <Select value={folderFilter} onValueChange={setFolderFilter}>
                <SelectTrigger className="w-[160px] border" style={{ backgroundColor: '#fff', borderColor: 'rgba(0,0,0,0.15)', color: '#1a1a1a' }}>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent style={{ backgroundColor: '#fff', borderColor: 'rgba(0,0,0,0.15)' }}>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline" className="border" style={{ backgroundColor: '#fff', borderColor: 'rgba(0,0,0,0.15)', color: '#1a1a1a' }}>
                    <Tag className="h-4 w-4 mr-2" />
                    Tags {selectedTags.length > 0 && `(${selectedTags.length})`}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-80" style={{ backgroundColor: '#fff', borderColor: 'rgba(0,0,0,0.15)' }}>
                  <div className="space-y-4">
                    <div className="flex gap-2">
                      <Input
                        placeholder="Add tag..."
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span
                        ...
                        style={{ 
                          backgroundColor: selectedTags.includes("__not_tagged__") ? '#586034' : '#fff',
                          borderColor: selectedTags.includes("__not_tagged__") ? '#586034' : 'rgba(0,0,0,0.15)',
                          color: selectedTags.includes("__not_tagged__") ? '#fff' : '#333'
                        }}
        ...
        {selectedFiles.length === 0 && (
          <Card
            ...
            style={{ 
              backgroundColor: isDragging ? 'rgba(88, 96, 52, 0.1)' : '#fff',
              borderColor: isDragging ? '#586034' : 'rgba(0,0,0,0.2)'
            }}
            onDrop={handleDrop}
            onDragOver={(e) => {
              e.preventDefault();
        ...
        {media === undefined ? (
          <Card style={{ backgroundColor: '#fff' }}>
            <CardContent className="p-12 text-center">
              <Loader2 className="h-8 w-8 animate-spin mx-auto mb-4" style={{ color: '#999' }} />
                  ...
                  <CardContent className="p-0">
                    <div className="relative">
                      ...
                      >
                        <Checkbox
                          checked={isSelected}
                          className="border-2 hover:border-accent data-[state=checked]:bg-accent data-[state=checked]:border-accent shadow-lg cursor-pointer pointer-events-none"
                          style={{ backgroundColor: 'rgba(255,255,255,0.95)', borderColor: 'rgba(0,0,0,0.3)' }}
                        />
                      </div>
                    </div>
                    <div className="p-3 space-y-2">
                      <p className="text-xs font-medium truncate" style={{ color: '#1a1a1a' }}>{item.filename}</p>
                      ...
                      {item.compressionRatio && item.compressionRatio > 0 && (
                        <span className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold" style={{ backgroundColor: 'rgba(34, 197, 94, 0.1)', color: '#16a34a', borderColor: 'rgba(34, 197, 94, 0.2)' }}>
                      ...
                      {item.tags.length > 0 && (
                        <div className="flex flex-wrap gap-1">
                          {item.tags.slice(0, 2).map((tag) => (
                            <span key={tag} className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold" style={{ backgroundColor: '#fff', borderColor: 'rgba(0,0,0,0.15)', color: '#333' }}>
                              {tag}
                            </span>
                          ))}
                          {item.tags.length > 2 && (
                            <span className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold" style={{ backgroundColor: '#fff', borderColor: 'rgba(0,0,0,0.15)', color: '#333' }}>
                              +{item.tags.length - 2}
                            </span>
                          )}
                        </div>
                      ...
                      {item.displayLocations && item.displayLocations.length > 0 && (
                        <div className="flex flex-wrap gap-1">
                          {item.displayLocations.map((loc, idx) => (
                            <span key={idx} className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold" style={{ backgroundColor: 'rgba(0,0,0,0.05)', borderColor: 'rgba(0,0,0,0.1)', color: '#333' }}>
          ...
          <Card style={{ backgroundColor: '#fff' }}>
            <CardContent className="p-12 text-center">
              <p style={{ color: '#888' }}>No media found</p>
            </CardContent>
          </Card>
        )}
