...
export default function EditPortfolioPage() {
  ...
  if (!portfolio) {
    return (
      <div className="mx-auto max-w-4xl px-4 sm:px-6 py-8 sm:py-12">
        <div className="text-center py-16">
          <p className="text-foreground/60 mb-4">Portfolio item not found</p>
        ...
        <Card className="border border-accent/30 bg-accent/5">
          <CardContent className="p-4 sm:p-6">
            <p className="text-sm text-foreground/80 leading-relaxed">
              <strong className="text-foreground font-black uppercase tracking-wider" style={{ fontWeight: '900' }}>Portfolio Items</strong> appear in the Portfolio section on your public homepage. These are curated pieces for public display - separate from client delivery portals. Portfolio items must have design, photo, or video categories to appear in the Portfolio section.
            </p>
          </CardContent>
        </Card>
