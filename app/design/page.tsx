...
export default function DesignPage() {
  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      {(design?.calUrl || design?.stripeUrl) && (
          ...
          <div className="mx-auto w-full max-w-[2000px] px-4 sm:px-6 md:px-8 lg:px-16 xl:px-20 2xl:px-24">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <p className="mb-8 text-base text-white/90 font-medium sm:text-lg md:text-xl">
                Choose how you'd like to get started—book directly through Cal.com or secure your project with a deposit.
              </p>
              <div className="flex flex-col gap-4 sm:flex-row sm:justify-center sm:gap-6">
                {design?.calUrl && (
                  <button
                    onClick={() => window.open(design.calUrl as string, "_blank")}
