      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-background border-foreground/20">
        ...
        <div className="space-y-6">
          ...
          {existingFeedback.length > 0 && (
            <div className="space-y-3 pt-4 border-t border-foreground/20">
              <h3 className="text-sm font-black uppercase tracking-wider" style={{ fontWeight: '900' }}>
                Previous Feedback
              </h3>
              {existingFeedback.map((fb) => (
                <div key={fb._id} className="rounded-md border border-foreground/10 bg-foreground/5 p-3">
